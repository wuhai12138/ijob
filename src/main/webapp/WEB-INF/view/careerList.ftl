                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title" style="padding: 0px 20px;">
                        <h2>就业/升学指导
                            ...
                            <button class="btn btn-primary pull-right dim" onclick="exportCareer()">导出</button>
                        </h2>
                    </div>
...
//            var row = $("#row").val();
        ...
        function searchThis(){
            ...
            var row = $("#row").val();
            var url = "infoListPage.do?type=4&types=5&row="+row+"&search="+search;
        ...
        function goPage(id){
            var search = $("#search").val();
            var row = $("#row").val();
            var url = "infoListPage.do?type=4&types=5&row="+row+"&search="+search+"&currentPage="+id;
            self.location.replace(url);
        }
        function exportCareer(){
            var url= "exportCareer.do";
            window.open(url);
        }
    </script>
</body>
