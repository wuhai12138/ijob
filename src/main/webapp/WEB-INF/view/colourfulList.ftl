...
//            var row = $("#row").val();
        ...
        function updateOne(id) {
            var con = $('#add-new-template').html();
//            var row = $("#row").val();
            var url = 'colourfulDetail.do?tid='+id;
        ...
        function searchThis(){
            ...
            var row = $("#row").val();
            var url = "infoListPage.do?type=7&row="+row+"&search="+search;
        ...
        function goPage(id){
            var search = $("#search").val();
            var row = $("#row").val();
            var url = "infoListPage.do?type=7&row="+row+"&search="+search+"&currentPage="+id;
            self.location.replace(url);
        }
        function exportBus(){
            var url= "exportBus.do?type=7";
            window.open(url);
        }
    </script>
</body>
