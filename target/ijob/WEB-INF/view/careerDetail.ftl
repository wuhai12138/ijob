        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="text" name="title" id="title" class="form-control" value="<#if updateCareer??>${updateCareer.title!''}</#if>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <textarea name="description" id="description" class="form-control"><#if updateCareer??>${updateCareer.description!''}</#if></textarea>
                        <span class="help-block m-b-none"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="text" name="link" id="link" class="form-control" value="<#if updateCareer??>${updateCareer.link!''}</#if>">
                        <span class="help-block m-b-none"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="text" name="limitNum" id="limitNum" class="form-control" value="<#if updateCareer??>${updateCareer.limitNum!''}</#if>">
                        <span class="help-block m-b-none"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        ...
                        <#if updateCareer??>
                            <option value="4" <#if updateCareer.type=="4">selected</#if>>就业指导</option>
                            <option value="5" <#if updateCareer.type=="5">selected</#if>>升学指导</option>
                        <#else>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        ...
                        <#if updateCareer??>
                            <option value="0" <#if updateCareer.canEnroll==0>selected</#if>>隐藏</option>
                            <option value="1" <#if updateCareer.canEnroll==1>selected</#if>>显示</option>
                        <#else>
...
<script>
    ...
    <#if updateCareer??>
        var url = "updateInfo.do?tid=${updateCareer.tid}"+"&title="+title+"&description="+description+"&link="+link
                +"&type="+type+"&canEnroll="+canEnroll+"&limitNum="+limitNum;
    <#else>
