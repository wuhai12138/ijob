            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title" style="padding: 0px 20px;">
                        <h2>校企合作 <button class="btn btn-primary pull-right dim" onclick="showAdd()">添加</button></h2>
                    </div>
                        ...
                        <div id="DataTables_Tables_0" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <div class="col-sm-6">
                                    <div class="dataTables_filter" id="DataTables_Table_0_filter">
                                        <div class="input-group has-success" style="float: right;">
                                            <input class="form-control input-sm" id="search" style="height: 36px;" placeholder="请输入企业名称搜索" <#if param.search??>value="${param.search}"</#if>>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">企业链接</th>
                                    <th class="text-center">操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                <#if companyList?exists>
                                    <#list companyList as list>
                                    <tr>
...
//            var row = $("#row").val();
        ...
        function updateOne(id) {
            var con = $('#add-new-template').html();
//            var row = $("#row").val();
            var url = 'companyDetail.do?tid='+id;
            layer.open({
                type: 2,
                title: '更新企业',
                maxmin: true,
        ...
        function searchThis(){
            ...
            var row = $("#row").val();
            var url = "companyList.do?row="+row+"&search="+search;
        ...
        function goPage(id){
            var search = $("#search").val();
            var row = $("#row").val();
            var url = "companyList.do?row="+row+"&search="+search+"&currentPage="+id;
            self.location.replace(url);
        }
    </script>
</body>
