            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title" style="padding: 0px 20px;">
                        <h2>实习心语 <button class="btn btn-primary pull-right dim" onclick="showAdd()">添加</button></h2>
                    </div>
...
//            var row = $("#row").val();
        ...
        function searchThis(){
            ...
            var row = $("#row").val();
            var url = "infoListPage.do?type=2&row="+row+"&search="+search;
        ...
        function goPage(id){
            var search = $("#search").val();
            var row = $("#row").val();
            var url = "infoListPage.do?type=2&row="+row+"&search="+search+"&currentPage="+id;
            self.location.replace(url);
        }
